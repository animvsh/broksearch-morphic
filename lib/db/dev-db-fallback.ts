...
export function canUseDevDbFallback(error: unknown) {
  ...
  const fallbackFragments: string[] = [
    ...
    'relation "workspaces"',
    'relation "brokcode_projects" does not exist',
    'relation "brokcode_project_files" does not exist',
    'relation "brokcode_generations" does not exist',
    'relation "brokcode_builds" does not exist',
    'relation "brokcode_deployments" does not exist',
    'relation "brokcode_runtime_sandboxes" does not exist',
    'relation "brokcode_versions" does not exist',
    'relation "brokcode_exports" does not exist',
    'relation "library_items" does not exist',
    'relation "library_tags" does not exist',
    'relation "library_item_tags" does not exist',
    'relation "spaces" does not exist',
    'relation "space_members" does not exist',
    'relation "space_projects" does not exist',
    'relation "space_invites" does not exist',
    'relation "discover_items" does not exist',
    'relation "trending_topics" does not exist',
    'enotfound',
    'ehostunreach',
    'econnrefused',
    'etimedout',
